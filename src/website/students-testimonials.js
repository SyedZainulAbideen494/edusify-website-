        ...
        <div className="row__testimonial__hero__section">
          <div className="col-12__testimonial__hero__section">
            <div className="hero-content__testimonial__hero__section">
              ...
              <p className="hero-description__testimonial__hero__section">Your all-in-one study companion designed to enhance learning, streamline organization, and foster collaboration among students.</p>
