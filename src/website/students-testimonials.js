    ...
    <div className="container__testimonial__hero__section">
      <div className="row__testimonial__hero__section">
        <div className="col-12__testimonial__hero__section">
          <div className="hero-content__testimonial__hero__section fade-in">
            <h1 className="hero-title__testimonial__hero__section">Join thousands of students enhancing their studies with our AI tools!</h1>
            ...
            <div className="user-stats__testimonial__hero__section fade-in-bottom">
              ...
              <img src="https://dropment.online/1728283961885.jpg" alt="User 4" className="user-icon__testimonial__hero__section  fade-in-bottom" />
              <div className="testimonial__hero__section__testimonial-text">
                <span className="user-text__testimonial__hero__section  fade-in-bottom" >
                  <strong className="big-number"> <TypeAnimation
          sequence={[
            '200,000+', // Text to type out
            1000
          ]}
          wrapper="span"
          cursor={true}
        ...
        /></strong><br /> students use Edusify every day!
                </span>
              </div>
            </div>
            <div className="hero-buttons fade-in-bottom">
              <button className="cssbuttons-io-button" onClick={openModal}>Get Started for Free
                <div className="icon">
